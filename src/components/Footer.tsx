          ...
          <div className="grid gap-5 md:grid-cols-3">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-300">
                Revisa bien los datos del vendedor, documentos del vehículo y
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-300">
                Las publicaciones permiten contacto rápido por WhatsApp entre
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-300">
                Destaca publicaciones, automotoras o banners desde tu cuenta.
              </p>
            </div>
          </div>
        </div>
